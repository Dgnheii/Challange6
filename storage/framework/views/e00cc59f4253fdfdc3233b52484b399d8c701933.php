                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('EditWeb', ['id'=>$a->id])); ?>" class="btn btn-primary">Edit</a>
                                    <a href="<?php echo e(route('deleteWeb', ['id'=>$a->id])); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\VertrigoServ\www\blog\resources\views/website/myFile.blade.php ENDPATH**/ ?>